...
GO
CREATE TABLE [dbo].[CheatTestMoves](
	...
	[Clock] [int] NULL,
 CONSTRAINT [PK_CTM_MoveID] PRIMARY KEY CLUSTERED 
(
	[MoveID] ASC
...
GO
ALTER TABLE [dbo].[CheatTestMoves] CHECK CONSTRAINT [FK_CTG_GameID]
GO
ALTER TABLE [dbo].[CheatTestMoves]  WITH CHECK ADD  CONSTRAINT [FK_CTM_PhaseID] FOREIGN KEY([PhaseID])
REFERENCES [dbo].[GamePhases] ([PhaseID])
GO
ALTER TABLE [dbo].[CheatTestMoves] CHECK CONSTRAINT [FK_CTM_PhaseID]
GO
