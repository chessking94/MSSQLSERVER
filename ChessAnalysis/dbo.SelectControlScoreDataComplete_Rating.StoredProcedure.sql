...
CREATE PROCEDURE [dbo].[SelectControlScoreDataComplete_Rating] (@Rating varchar(4))
...
CASE WHEN r.RatingGroup = 'Unr' THEN r.RatingGroup ELSE CAST(r.LBound AS varchar(4)) END AS RatingGroup,
...
CASE WHEN r.RatingGroup = 'Unr' THEN r.RatingGroup ELSE CAST(r.LBound AS varchar(4)) END
