...
GO
CREATE PROCEDURE [dbo].[SelectEEHScoreDataPhase_Variables] (@OppLastName varchar(50), @OppFirstName varchar(30), @MinOppRating int, @MaxOppRating int, @MinDate datetime, @MaxDate datetime, @ECO varchar(3), @Tmnt varchar(100))
