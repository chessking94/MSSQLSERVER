...
GO
ALTER TABLE [dbo].[TimeControls]  WITH CHECK ADD  CONSTRAINT [FK_TC_TimeControlType] FOREIGN KEY([TimeControlType])
REFERENCES [dbo].[TimeControlTypes] ([TimeControlType])
GO
ALTER TABLE [dbo].[TimeControls] CHECK CONSTRAINT [FK_TC_TimeControlType]
GO
