...
GO
ALTER TABLE [dbo].[OnlineMoves] ADD  CONSTRAINT [CSR_OM_DateAdded]  DEFAULT (getdate()) FOR [DateAdded]
GO
ALTER TABLE [dbo].[OnlineMoves]  WITH CHECK ADD  CONSTRAINT [FK_OM_GameID] FOREIGN KEY([GameID])
REFERENCES [dbo].[OnlineGames] ([GameID])
GO
ALTER TABLE [dbo].[OnlineMoves] CHECK CONSTRAINT [FK_OM_GameID]
GO
ALTER TABLE [dbo].[OnlineMoves]  WITH CHECK ADD  CONSTRAINT [FK_OM_PhaseID] FOREIGN KEY([PhaseID])
REFERENCES [dbo].[GamePhases] ([PhaseID])
GO
ALTER TABLE [dbo].[OnlineMoves] CHECK CONSTRAINT [FK_OM_PhaseID]
GO
